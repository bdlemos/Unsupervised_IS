...
def main():
    ...
    p.add_argument("--selection-csv", default="/home/bernardo/projects/unsupervised-is/resources/outsel/selection_summary.csv", help="CSV with selection reduction values to include (optional)")
