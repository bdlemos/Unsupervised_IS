...
def main():
    ...
    p.add_argument("--selection-csv", default=os.environ.get("RESULTS_DIR", "/app/results") + "/instance_selection/selection_summary.csv", help="CSV with selection reduction and time values")
