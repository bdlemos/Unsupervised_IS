...
def main():
    ...
    p.add_argument("--selection-csv", default=os.environ.get("UNSUPERVISED_IS_RESOURCES", "/app/unsupervised-is/resources") + "/outsel/selection_summary.csv", help="CSV with selection reduction and time values")
