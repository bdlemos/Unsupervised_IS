...
def main():
    ...
    p.add_argument("--selection-csv", default=os.path.join(default_results_dir, "instance_selection", "selection_summary.csv"), help="CSV with selection reduction and time values")
